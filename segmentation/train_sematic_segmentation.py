...
import numpy as np
from .test_sematic_segmentation import test_whole_scene
...
if __name__ == '__main__':
    ...
    info, class_IoU = test_whole_scene(model, test_data_container, test_meter, 32, 4096)
