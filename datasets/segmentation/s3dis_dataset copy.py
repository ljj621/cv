...
class S3DISDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        # normalize
        selected_points = data[selected_point_idxs, :]  # num_point * 3
        current_points = np.zeros((self.num_point, 9))  # num_point * 3
        current_points[...,0] = selected_points[...,0] - center[0]
        current_points[...,1] = selected_points[...,1] - center[1]
        current_points[...,2] = selected_points[...,2]
        current_points[...,3:6] = selected_points[...,3:] / 255.
        ...
        data_dict = {}
        points = Points(data=current_points, seg_labels=current_labels)
